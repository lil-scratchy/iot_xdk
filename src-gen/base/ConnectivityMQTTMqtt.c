 ...
 */
static const char* MQTT_CLIENT_ID = "sensor1";
...
/**
 * Provides read access to the light signal.
 */
...
/**
 * Provides write access to the light signal.
 */
Retcode_T ConnectivityMQTTMqtt_Light_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static char *topic = "scratchy/1/light";
 ...
 */
Retcode_T ConnectivityMQTTMqtt_O2_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static StringDescr_T publishTopicDescription;
	static char *topic = "scratchy/1/o2";
	StringDescr_wrap(&publishTopicDescription, topic);
...
/**
 * Provides read access to the temp signal.
 */
...
/**
 * Provides write access to the temp signal.
 */
Retcode_T ConnectivityMQTTMqtt_Temp_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static StringDescr_T publishTopicDescription;
	static char *topic = "scratchy/1/temp";
	StringDescr_wrap(&publishTopicDescription, topic);
...
/**
 * Provides read access to the pres signal.
 */
...
/**
 * Provides write access to the pres signal.
 */
Retcode_T ConnectivityMQTTMqtt_Pres_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static StringDescr_T publishTopicDescription;
	static char *topic = "scratchy/1/pres";
	StringDescr_wrap(&publishTopicDescription, topic);
...
/**
 * Provides read access to the humi signal.
 */
...
/**
 * Provides write access to the humi signal.
 */
Retcode_T ConnectivityMQTTMqtt_Humi_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static StringDescr_T publishTopicDescription;
	static char *topic = "scratchy/1/humi";
	StringDescr_wrap(&publishTopicDescription, topic);
...
/**
 * Provides read access to the co2 signal.
 */
...
/**
 * Provides write access to the co2 signal.
 */
Retcode_T ConnectivityMQTTMqtt_Co2_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static StringDescr_T publishTopicDescription;
	static char *topic = "scratchy/1/co2";
	StringDescr_wrap(&publishTopicDescription, topic);
...
/**
 * Provides read access to the tvoc signal.
 */
...
/**
 * Provides write access to the tvoc signal.
 */
Retcode_T ConnectivityMQTTMqtt_Tvoc_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static StringDescr_T publishTopicDescription;
	static char *topic = "scratchy/1/tvoc";
	StringDescr_wrap(&publishTopicDescription, topic);
...
/**
 * Provides read access to the mc10 signal.
 */
...
/**
 * Provides write access to the mc10 signal.
 */
Retcode_T ConnectivityMQTTMqtt_Mc10_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static StringDescr_T publishTopicDescription;
	static char *topic = "scratchy/1/mc10";
	StringDescr_wrap(&publishTopicDescription, topic);
...
/**
 * Provides read access to the mc25 signal.
 */
...
/**
 * Provides write access to the mc25 signal.
 */
Retcode_T ConnectivityMQTTMqtt_Mc25_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static StringDescr_T publishTopicDescription;
	static char *topic = "scratchy/1/mc25";
	StringDescr_wrap(&publishTopicDescription, topic);
...
/**
 * Provides read access to the mc40 signal.
 */
...
/**
 * Provides write access to the mc40 signal.
 */
Retcode_T ConnectivityMQTTMqtt_Mc40_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static StringDescr_T publishTopicDescription;
	static char *topic = "scratchy/1/mc40";
	StringDescr_wrap(&publishTopicDescription, topic);
...
/**
 * Provides read access to the mc100 signal.
 */
...
/**
 * Provides write access to the mc100 signal.
 */
Retcode_T ConnectivityMQTTMqtt_Mc100_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static StringDescr_T publishTopicDescription;
	static char *topic = "scratchy/1/mc100";
	StringDescr_wrap(&publishTopicDescription, topic);
...
/**
 * Provides read access to the partical_s signal.
 */
...
/**
 * Provides write access to the partical_s signal.
 */
Retcode_T ConnectivityMQTTMqtt_Partical_s_Write(char** value)
{
	Retcode_T exception = RETCODE_OK;
	...
	static StringDescr_T publishTopicDescription;
	static char *topic = "scratchy/1/partical_s";
	StringDescr_wrap(&publishTopicDescription, topic);
